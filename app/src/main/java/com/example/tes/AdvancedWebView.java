    ...
    protected void init(Context context) {
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public void onUnhandledInputEvent(WebView view, InputEvent event) {
                if (mCustomWebViewClient != null) {
                    try {
                        Method method = mCustomWebViewClient.getClass().getMethod("onUnhandledInputEvent", view.getClass(), event.getClass());
                        method.invoke(mCustomWebChromeClient, view, event);
                    ...
                    try {
                        MethodHandle method = MethodHandles.lookup().findSpecial(WebViewClient.class,"onUnhandledInputEvent", MethodType.methodType(Void.TYPE),
